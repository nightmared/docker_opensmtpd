...
RUN wget -q https://raw.githubusercontent.com/nightmared/le_dns_online/master/lets_encrypt/dns_online_rust.sh -O /root/config/acme.sh/dnsapi/dns_online_rust.sh
